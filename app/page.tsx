    ...
    <div className="min-h-screen bg-gradient-to-br from-background to-muted">
      ...
      <header className="container mx-auto px-4 py-6">
        <nav className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-2xl font-bold text-foreground">TeamFlow</span>
          </div>
      ...
      <main className="container mx-auto px-4 py-16">
        ...
        <div className="bg-card rounded-2xl p-12 mt-20 text-center shadow-xl border">
          ...
          <p className="text-lg text-muted-foreground mb-8">
            Join thousands of teams already using TeamFlow to manage their projects efficiently.
          </p>
          <Link href="/auth/sign-up">
      ...
      <footer className="container mx-auto px-4 py-8 mt-16 border-t">
        <div className="text-center text-muted-foreground">
          <p>&copy; 2024 TeamFlow. Built for teams that get things done.</p>
        </div>
      </footer>
    </div>
  )
